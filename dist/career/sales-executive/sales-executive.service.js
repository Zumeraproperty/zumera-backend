...
let SalesExecutiveService = class SalesExecutiveService {
    ...
    async create(createSalesExecutiveDto) {
        const createdSalesExecutive = new this.salesExecutiveModel(createSalesExecutiveDto);
    ...
    async update(id, updateData) {
        ...
        if (!updatedSalesExecutive) {
            throw new common_1.NotFoundException(`Sales Executive with ID "${id}" not found`);
        }
...
exports.SalesExecutiveService = SalesExecutiveService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(sales_executive_schema_1.SalesExecutive.name)),
