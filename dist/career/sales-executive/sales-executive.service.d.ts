...
export declare class SalesExecutiveService {
    ...
    create(createSalesExecutiveDto: CreateSalesExecutiveDto): Promise<SalesExecutive>;
    findAll(): Promise<SalesExecutive[]>;
    update(id: string, updateData: CreateSalesExecutiveDto): Promise<SalesExecutive>;
