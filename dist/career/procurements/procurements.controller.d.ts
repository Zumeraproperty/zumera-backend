...
export declare class ProcurementsController {
    ...
    create(createProcurementsDto: CreateProcurementsDto): Promise<import("./schemas/procurements.schema").Procurements>;
    findAll(): Promise<import("./schemas/procurements.schema").Procurements[]>;
    update(id: string, updateData: CreateProcurementsDto): Promise<import("./schemas/procurements.schema").Procurements>;
    remove(id: string): Promise<import("./schemas/procurements.schema").Procurements>;
}
