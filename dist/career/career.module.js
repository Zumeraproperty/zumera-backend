    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: accounting_and_finances_schema_1.AccountingAndFinances.name, schema: accounting_and_finances_schema_1.AccountingAndFinancesSchema },
                {
                ...
                { name: civil_engineerings_schema_1.CivilEngineerings.name, schema: civil_engineerings_schema_1.CivilEngineeringsSchema },
                { name: cooperate_attorneys_schema_1.CooperateAttorneys.name, schema: cooperate_attorneys_schema_1.CooperateAttorneysSchema },
                { name: hrs_schema_1.Hrs.name, schema: hrs_schema_1.HrsSchema },
                { name: operations_schema_1.Operations.name, schema: operations_schema_1.OperationsSchema },
                { name: procurements_schema_1.Procurements.name, schema: procurements_schema_1.ProcurementsSchema },
                {
                ...
                { name: sales_executive_schema_1.SalesExecutive.name, schema: sales_executive_schema_1.SalesExecutiveSchema },
            ]),
        ],
