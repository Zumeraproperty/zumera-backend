...
let ProjectManagerExecutiveService = class ProjectManagerExecutiveService {
    ...
    async create(createProjectManagerExecutiveDto) {
        const createdProjectManagerExecutive = new this.projectManagerExecutiveModel(createProjectManagerExecutiveDto);
    ...
    async update(id, updateData) {
        ...
        const updatedProjectManagerExecutive = await this.projectManagerExecutiveModel
    ...
    async remove(id) {
        const deletedProjectManagerExecutive = await this.projectManagerExecutiveModel.findByIdAndDelete(id).exec();
...
exports.ProjectManagerExecutiveService = ProjectManagerExecutiveService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(project_manager_executive_schema_1.ProjectManagerExecutive.name)),
