...
import { CivilEngineerings, CivilEngineeringsDocument } from './schemas/civil-engineerings.schema';
...
export declare class CivilEngineeringsService {
    ...
    create(createCivilEngineeringsDto: CreateCivilEngineeringsDto): Promise<CivilEngineerings>;
    findAll(): Promise<CivilEngineerings[]>;
    update(id: string, updateData: CreateCivilEngineeringsDto): Promise<CivilEngineerings>;
