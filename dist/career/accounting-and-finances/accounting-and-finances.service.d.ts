...
import { AccountingAndFinances, AccountingAndFinancesDocument } from './schemas/accounting-and-finances.schema';
...
export declare class AccountingAndFinancesService {
    ...
    create(createAccountingAndFinancesDto: CreateAccountingAndFinancesDto): Promise<AccountingAndFinances>;
    findAll(): Promise<AccountingAndFinances[]>;
    update(id: string, updateData: CreateAccountingAndFinancesDto): Promise<AccountingAndFinances>;
