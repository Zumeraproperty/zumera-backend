...
let AccountingAndFinancesService = class AccountingAndFinancesService {
    ...
    async create(createAccountingAndFinancesDto) {
        const createdAccountingAndFinances = new this.accountingAndFinancesModel(createAccountingAndFinancesDto);
    ...
    async update(id, updateData) {
        ...
        if (!updatedAccountingAndFinances) {
            throw new common_1.NotFoundException(`Accounting and Finances with ID "${id}" not found`);
        }
...
exports.AccountingAndFinancesService = AccountingAndFinancesService = __decorate([
