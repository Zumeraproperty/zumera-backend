...
exports.CareerService = CareerService = __decorate(
  [
    ...
    __param(
      1,
      (0, mongoose_1.InjectModel)(
        architecture_and_designs_schema_1.ArchitectureAndDesigns.name,
      ),
    ),
    __param(
      2,
    ...
    __param(
      3,
      (0, mongoose_1.InjectModel)(
        cooperate_attorneys_schema_1.CooperateAttorneys.name,
      ),
    ),
    __param(4, (0, mongoose_1.InjectModel)(hrs_schema_1.Hrs.name)),
    __param(
      5,
      (0, mongoose_1.InjectModel)(operations_schema_1.Operations.name),
    ),
    __param(
      6,
      (0, mongoose_1.InjectModel)(procurements_schema_1.Procurements.name),
    ),
    __param(
      7,
      (0, mongoose_1.InjectModel)(
