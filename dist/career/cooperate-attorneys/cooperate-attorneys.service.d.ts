...
import { CooperateAttorneys, CooperateAttorneysDocument } from './schemas/cooperate-attorneys.schema';
...
export declare class CooperateAttorneysService {
    ...
    create(createCooperateAttorneysDto: CreateCooperateAttorneysDto): Promise<CooperateAttorneys>;
    findAll(): Promise<CooperateAttorneys[]>;
    update(id: string, updateData: CreateCooperateAttorneysDto): Promise<CooperateAttorneys>;
