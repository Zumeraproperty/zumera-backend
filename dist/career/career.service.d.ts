...
export declare class CareerService {
  ...
  private salesModel;
  constructor(
    accountingModel: Model<AccountingAndFinances>,
    architectureModel: Model<ArchitectureAndDesigns>,
    civilModel: Model<CivilEngineerings>,
    attorneyModel: Model<CooperateAttorneys>,
    hrModel: Model<Hrs>,
    operationsModel: Model<Operations>,
    procurementModel: Model<Procurements>,
    projectManagerModel: Model<ProjectManagerExecutive>,
    salesModel: Model<SalesExecutive>,
  );
  findAllJobs(): Promise<{
    ...
    Hrs: (import("mongoose").Document<unknown, {}, Hrs> &
      Hrs & {
        _id: import("mongoose").Types.ObjectId;
      } & {
        __v?: number;
      })[];
    Operations: (import("mongoose").Document<unknown, {}, Operations> &
      Operations & {
        _id: import("mongoose").Types.ObjectId;
      } & {
        __v?: number;
      })[];
    Procurements: (import("mongoose").Document<unknown, {}, Procurements> &
      Procurements & {
        _id: import("mongoose").Types.ObjectId;
      } & {
        __v?: number;
    ...
    SalesExecutives: (import("mongoose").Document<unknown, {}, SalesExecutive> &
      SalesExecutive & {
        _id: import("mongoose").Types.ObjectId;
      } & {
        __v?: number;
